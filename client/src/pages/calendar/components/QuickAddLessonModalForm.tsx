...
const QuickAddLessonModalForm: React.FC<QuickAddLessonModalFormProps> = (
  props: QuickAddLessonModalFormProps
) => {
      ...
      >
        <Form layout="vertical">
          ...
          <Checkbox
            ...
            onChange={() => setEventRepeats(!eventRepeats)}
          >
            This event repeats
          </Checkbox>
            ...
            <div className="blockFrequencyType">
              ...
              {frequencyType === "1" && (
                <div>
                  ...
                  <Checkbox
                    checked={repeatIdentity}
                    onChange={() => setRepeatIdentity(!repeatIdentity)}
                  >
                    Repeat indefinitely
                  </Checkbox>
                </div>
                  ...
                  <div style={{ marginBottom: "10px" }}>
                    ...
                    <Radio.Group onChange={() => {}}>
                      ...
                      <Radio value={2}>
                        ...
                        {nthNumber(getNumberOfWeek(props.selectedDate))}{" "}
          ...
          <div style={{ marginTop: "15px" }}>
            ...
            <Radio.Group>
              <Space direction="vertical">
                ...
                <Radio value="private">
                  Private - Visible on the Student Portal calendar to current
                  attendees only
                </Radio>
              </Space>
            </Radio.Group>

            <Checkbox value="stateMakeUpCredit" style={{marginTop: "25px"}}>This event requires a make-up credit</Checkbox>
          </div>
        </Form>
      </Modal>
    </>

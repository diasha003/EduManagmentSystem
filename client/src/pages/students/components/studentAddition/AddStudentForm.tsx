import { Button, Col, Collapse, DatePicker, Divider, Form, Input, Radio, RadioChangeEvent, Row, Select, Space, Typography } from "antd";
    ...
    <Form layout="vertical" className="formStyle" onFinish={onFinish}>
        ...
        <Col span={22}>
          <Form.Item
            ...
            <Radio.Group onChange={onChangeRadioGroupHasFamily}   >
              <Radio value={false} style={{ marginRight: "190px" }}>New Family</Radio>
      ...
      {typeof hasFamily === 'boolean' && (
        !hasFamily ? <>
          ...
          <Row gutter={10}>
            <Col span={11}>
              <Form.Item name="family_list" label="Family" rules={[
                {
                  required: hasFamily,
                },
              ]}>
      ...
      <Row style={{ alignItems: "center" }} gutter={10}>
        ...
        <Col span={11} style={{ display: "flex", justifyContent: "flex-end" }}>
          <Button size="middle" icon={<PlusOutlined />} style={{ marginRight: 0 }} onClick={() => {
